...
-- Generated on: 2025-09-29 09:50:44
-- Schema: public
...
-- Generated from scoring.yaml for schema: public
-- Auto-detected actual schema from database
...
-- Create indexes
CREATE INDEX idx_aerospace_score ON public.aerospace_supplier_candidates(aerospace_score);
CREATE INDEX idx_tier ON public.aerospace_supplier_candidates(tier_classification);
CREATE INDEX idx_postcode ON public.aerospace_supplier_candidates(postcode);
CREATE INDEX idx_geom ON public.aerospace_supplier_candidates USING GIST(geometry);

-- STEP 4: Insert final results
-- Insert enriched aerospace supplier candidates
